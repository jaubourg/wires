...
class Config {
    ...
    constructor( directory, parent ) {
        ...
        if ( parent ) {
            setFieldDefault( this, `_data`, parent.rawValue( this._namespace ) );
            setFieldDefault( this, `_routes`, parent._routes );
            this._dirRoutes = dirRoutes.merge( this._dirRoutes, parent._dirRoutes );
        }
