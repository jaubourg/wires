...
class Config {
    ...
    constructor( directory, getParent ) {
        ...
        this._namespace = rawConfig.getDirective( `@namespace` );
        this._data = new Data();
        ...
        this._addFile( rawConfig.get( `env` ), directory );
        this._addFile( rawConfig.get( `main` ), directory );
        if ( getParent && !rawConfig.getDirective( `@root` ) ) {
            this._addParent( getParent() );
        }
        this._addFile( rawConfig.get( `envDefaults` ), directory );
        this._addFile( rawConfig.get( `defaults` ), directory );
    }
